...
<div>
  <figure align="left"> 
    <p style="font-size: 14px;">
      <blockquote>
        <strong>1. 서비스 종료 일자(end_date) 수정</strong>
          <div>
            <p style="font-size: 14px;">
            <li>전) <br>
...
<figure align="left"> 
    <p style="font-size: 14px;">
      <blockquote>
        <strong>1. 처방 정보 조회 및 추가</strong><br>
